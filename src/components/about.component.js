...
const About = ()=>{
    return <section className="px-2 py-2 md:px-12 md:py-10 " >
        <div id='sale' className="shadow-md rounded-2xl bg-slate-700">
            {/* TOP CENTER */}
...
inspired by the success of meme coin Shiba Inu & NFT coin Decentraland(MANA), from that we started a project on it and it may kill both Shiba Inu and Decentraland(MANA) in 2022.</p>
            ...
            {/* right */}
            <div className='flex flex-row mb-5 justify-center text-xl  text-gray-100 mt-3'>
